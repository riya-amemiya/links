/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 65a93ce746d2e99ba7d3bea897cb69b4)
// Runtime types generated with workerd@1.20260811.1 2026-04-07 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	MICROCMS_SERVICEDOMAIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MICROCMS_SERVICEDOMAIN" | "MICROCMS_API_KEY" | "NEXT_PUBLIC_URL" | "RESUME_FEATURE">> {}
}
